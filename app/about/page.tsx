          ...
          <div className="container mx-auto max-w-5xl">
            ...
            <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                ...
                barriers that prevent everyday users from safely participating in the decentralized financial ecosystem.
              </p>
              <p>
                ...
                digital economy, allowing users to take full control of their financial autonomy in a secure, efficient,
