...
export default function SupportPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a1f0a] via-[#0d2b0d] to-[#0a1f0a]">
      <Header />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-[#c8ff00]/50 transition-all">
              ...
              <p className="text-gray-400 mb-6">Send us an email and our team will get back to you within 24 hours.</p>
              <a
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-lg">
                  Our support team is available <span className="text-[#c8ff00] font-semibold">24/7</span> to assist you
                  with any inquiries.
                </p>
              </div>
            </div>
